...
class OpenAIProvider:
    ...
    def repair_with_tokens(self, raw: str, schema: dict[str, Any]) -> FallbackResult:
        ...
        try:
            ...
            return FallbackResult(repaired_text=txt, fu_tokens=total_tokens, success=True)

        except Exception as e:
            return FallbackResult(
                repaired_text=None, fu_tokens=0, success=False, error=str(e)[:200]
            )
    ...
    def check_tenant_fu_quota(
        self, tenant_config: dict[str, Any], estimated_tokens: int
    ) -> tuple[bool, str]:
        """
